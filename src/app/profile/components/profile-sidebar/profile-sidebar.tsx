					...
					{PROFILE_MENU.map((item: any & { children?: ISettingsItem[] }) => {
						...
						return (
							<li key={item.id}>
								<div
									className={cn(
										'flex items-center gap-x-3 py-3 rounded-lg text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-black dark:text-[#939393] dark:hover:text-white cursor-pointer transition-all duration-200',
