		...
		<LazyMotion features={domAnimation}>
			<div className='flex justify-center pt-14 sm:pt-[80px] md:pt-[120px] lg:pt-[110px] xl:pt-[160px] select-none'>
				<m.div
					...
					className='relative flex rounded-[20px] py-2 bg-white dark:bg-[#151515] border border-[#d9d7d7] dark:border-[#3a3a3a]'
				>
					<div
						className={clsx(
							'hidden lg:block absolute top-0 left-0 h-[61px] bg-zinc-100 dark:bg-neutral-800 rounded-[20px] transition-all duration-200 ease-in-out z-0',
						...
						{TABS.map((tab, index) => (
							...
							>
								<button
									...
									className={clsx(
										'md:px-5 md:py-2 px-3.5 py-1.5 rounded-[20px] text-base lg:text-lg transition-colors duration-300 whitespace-nowrap',
										activeTab === tab.id
